...
const InferencePlayground: React.FC = () => {
  ...
  const models = [
    { id: 'llama-3-finance', name: 'Llama-3 Finance', type: 'Fine-tuned', size: '8B' },
    { id: 'mistral-chat', name: 'Mistral Chat', type: 'Fine-tuned', size: '7B' },
    { id: 'llama-2-base', name: 'Llama-2 Base', type: 'Base Model', size: '13B' },
  ];
              ...
              <div className="space-y-20">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSettings({ ...settings, stopSequences: e.target.value })
                    }
            ...
            <div className="mt-16 p-12 bg-dark-bg-tertiary rounded-lg">
              <div className="grid grid-cols-3 gap-16 text-center text-small">
                ...
                <div>
                  ...
                  <div className="text-dark-text-primary font-medium">24 tok/s</div>
                </div>
              </div>
            </div>
          )}
