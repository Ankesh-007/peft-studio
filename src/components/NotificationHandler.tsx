...
export const NotificationHandler: React.FC<NotificationHandlerProps> = ({
  ...
  const showDesktopNotification = useCallback(async (options: NotificationOptions) => {
    try {
  ...
  const handleNotification = useCallback(async (notification: NotificationOptions) => {
