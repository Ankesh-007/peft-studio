...
export const AccessibleButton = forwardRef<HTMLButtonElement, AccessibleButtonProps>(
  (
    ...
    const variantClasses = {
      ...
      secondary: 'bg-dark-bg-tertiary text-dark-text-primary hover:bg-dark-bg-tertiary/80 focus:ring-dark-border',
      ghost: 'bg-transparent border border-dark-border text-dark-text-secondary hover:bg-dark-bg-tertiary hover:text-dark-text-primary focus:ring-dark-border',
