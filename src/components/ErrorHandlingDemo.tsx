...
export const ErrorHandlingDemo: React.FC = () => {
  ...
  const handleTriggerGlobalError = () => {
    ...
    showGlobalError(error, { component: 'ErrorHandlingDemo', action: 'trigger_global' });
  };

  const handleTriggerLocalError = () => {
    const error = errorExamples[selectedErrorType as keyof typeof errorExamples];
    handleLocalError(error, { component: 'ErrorHandlingDemo', action: 'trigger_local' });
  };
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600 mb-6">
          This demo shows how the error handling system formats errors into plain language
