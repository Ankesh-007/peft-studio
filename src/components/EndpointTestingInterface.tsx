            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTestInput({ ...testInput, max_tokens: parseInt(e.target.value) })
                    }
                    min="1"
                    max="4096"
                    className="w-full px-4 py-2 border rounded-lg"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTestInput({ ...testInput, temperature: parseFloat(e.target.value) })
                    }
                    min="0"
                    max="2"
                    step="0.1"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTestInput({ ...testInput, top_p: parseFloat(e.target.value) })
                  }
                  min="0"
                  max="1"
                  step="0.1"
