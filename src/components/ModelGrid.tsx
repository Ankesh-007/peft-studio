            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {(model as any).registry && (
                    <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded text-xs">
                      {(model as any).registry as React.ReactNode}
                    </span>
                  )}
                </div>
                <div className="flex items-center gap-4 mt-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  {model.parameters && <span>{formatNumber(model.parameters)} params</span>}
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${isInComparison(model.model_id)
        ...
        >
          <div className="flex items-start justify-between mb-2">
            ...
            <button
              ...
              disabled={isInComparison(model.model_id) || comparisonModels.length >= 4}
              className={`p-1 rounded ${isInComparison(model.model_id)
