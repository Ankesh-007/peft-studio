...
describe('Tooltip Completeness Property Tests', () => {
  ...
  it('property: for any configuration key with a tooltip, it should have all required fields', () => {
    ...
    fc.assert(
      fc.property(
        fc.constantFrom(...getAllTooltipKeys()),
        (configKey) => {
  ...
  it('property: all tooltips should be accessible and complete', () => {
    ...
    fc.assert(
      fc.property(
        fc.constantFrom(...requiredConfigKeys),
        (configKey) => {
          // Tooltip must exist
          ...
          if (tooltip) {
            ...
            const isActionable = 
              ...
              (tooltip.example !== undefined || tooltip.description.includes('typical') || 
               tooltip.description.includes('common') || tooltip.description.includes('usually'));
