...
describe('Accessibility Tests', () => {
  describe('TrainingWizard', () => {
    it('should have proper ARIA labels on navigation', () => {
      ...
      expect(screen.getByRole('navigation', { name: /training wizard progress/i })).toBeInTheDocument();
    });
  ...
  describe('Loading States', () => {
    it('should show loading skeleton while data loads', () => {
      ...
      const loadingElement = screen.getByRole('status', { name: /loading dashboard/i });
